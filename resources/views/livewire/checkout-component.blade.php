                ...
                <div class="wrap-address-billing">
                    ...
                    <div class="billing-address">
                        ...
                        <p class="row-in-form">
                            ...
                            <input type="text" name="country" value="" placeholder="United States" wire:model="city">
                        ...
                        <p class="row-in-form fill-wife">
                            <label class="checkbox-field">
                                <input name="different-add" id="different-add" type="checkbox" wire:model="ship_to_different" value="1" />
            ...
            <div class="col-md-12">
                <div class="wrap-address-billing">
                    ...
                    <div class="billing-address">
                        ...
                        <p class="row-in-form">
                            <label for="country">Country<span>*</span></label>
                            <input type="text" name="country" value="" placeholder="United States" wire:model="s_city">
