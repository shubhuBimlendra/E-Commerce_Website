                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="saveSettings">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="Twitter" placeholder="Twitter" class="form-control input-md" wire:model="twitter"/>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Insatagram</label>
                                <div class="col-md-4">
                                    <input type="Insatagram" placeholder="Insatagram" class="form-control input-md" wire:model="instagram"/>
