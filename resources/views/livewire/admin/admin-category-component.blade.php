                                    ...
                                    <td>
                                        <ul class="sclist">
                                            ...
                                            <li><i class="fa fa-caret-right"></i>{{$scategory->name}}
                                                <a href="{{route('admin.editcategory',['category_slug'=>$category->slug,'scategory_slug'=>$scategory->slug])}}" class="slink"><i class="fa fa-edit"></i>
                                                <a href="#" onclick="confirm('Are you sure, You want to delete this sub-category?') || event.stopImmediatePropagation()" wire:click.prevent="deleteSubcategory({{$scategory->id}})" class="slink"><i class="fa fa-times fa-2x text-danger"></i></a>
                                            </li>
                                            @endforeach
                                        </ul>
                                    </td>
